...
public class EditSellActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.advertiser_activity_edit_sell);
        Bundle extras = getIntent().getExtras();
        AdvertiserViewModel viewModel = AdvertiserViewModel.getInstance();

        MaterialToolbar toolbar = findViewById(R.id.advertiser_activity_edit_sell_toolbar);
        setSupportActionBar(toolbar);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        EditText brand = ((EditText) findViewById(R.id.advertiser_activity_edit_sell_rental_brand_et));
        EditText model = ((EditText) findViewById(R.id.advertiser_activity_edit_sell_rental_model_et));
        EditText year = ((EditText) findViewById(R.id.advertiser_activity_edit_sell_rental_year_et));
        EditText distance = ((EditText) findViewById(R.id.advertiser_activity_edit_sell_rental_distance_et));
        EditText price = ((EditText) findViewById(R.id.advertiser_activity_edit_sell_rental_price_et));
        LinearLayout imagesLayout = findViewById(R.id.advertiser_activity_edit_sell_rental_imagell);
        ...
        Button editBT = findViewById(R.id.advertiser_activity_edit_sell_rental_editbt);
